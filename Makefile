...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(top_srcdir)/ext/libASICamera/armv5/libASICamera.a \
	$(top_srcdir)/ext/libASICamera/armv5/libASICamera2.a \
	$(top_srcdir)/ext/libASICamera/armv6/libASICamera.a \
	$(top_srcdir)/ext/libASICamera/armv6/libASICamera2.a \
	$(top_srcdir)/ext/libASICamera/armv7/libASICamera.a \
	$(top_srcdir)/ext/libASICamera/armv7/libASICamera2.a \
	$(top_srcdir)/ext/libASICamera/mac32/libASICamera.a \
	$(top_srcdir)/ext/libASICamera/mac32/libASICamera2.a \
	$(top_srcdir)/ext/libASICamera/mac64/libASICamera.a \
	$(top_srcdir)/ext/libASICamera/mac64/libASICamera2.a \
	$(top_srcdir)/ext/libASICamera/x64/libASICamera.a \
	$(top_srcdir)/ext/libASICamera/x64/libASICamera2.a \
	$(top_srcdir)/ext/libASICamera/x86/libASICamera.a \
	$(top_srcdir)/ext/libASICamera/x86/libASICamera2.a \
	$(top_srcdir)/ext/libaltaircam/mac64/libaltaircam.dylib \
	$(top_srcdir)/ext/libaltaircam/x64/libaltaircam.so \
	$(top_srcdir)/ext/libaltaircam/x86/libaltaircam.so \
	$(top_srcdir)/ext/libtoupcam/mac64/libtoupcam.dylib \
	$(top_srcdir)/ext/libtoupcam/x64/libtoupcam.so \
	$(top_srcdir)/ext/libtoupcam/x86/libtoupcam.so COPYING INSTALL \
...
UIC = uic-qt5
VERSION = 1.0.0
abs_builddir = /home/oliver/dev/oacapture-1.0.0
abs_srcdir = /home/oliver/dev/oacapture-1.0.0
...
SUBDIRS = liboacam liboademosaic liboaSER liboavideo liboafilterwheel \
          liboaPTR liboaimgproc liboautil ext oacapture oalive
