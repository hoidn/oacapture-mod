  ...
  switch ( control ) {
    ...
    case OA_CAM_CTRL_EXPOSURE_ABSOLUTE:
    {
      ...
      if ( euvcUsbControlMsg ( cameraInfo, USB_DIR_OUT | USB_CTRL_TYPE_CLASS |
          ...
          ( char* ) &exp100ns, sizeof ( exp100ns ), USB_CTRL_TIMEOUT ) !=
          sizeof ( exp100ns )) {
    ...
    case OA_CAM_CTRL_GAIN:
    {
      ...
      if ( euvcUsbControlMsg ( cameraInfo, USB_DIR_OUT | USB_CTRL_TYPE_CLASS |
          ...
          cameraInfo->processingUnitId << 8, ( char* ) &cameraInfo->currentGain,
    ...
    case OA_CAM_CTRL_BRIGHTNESS:
    {
      ...
      if ( euvcUsbControlMsg ( cameraInfo, USB_DIR_OUT | USB_CTRL_TYPE_CLASS |
          ...
          ( char* ) &cameraInfo->currentBrightness,
    ...
    case OA_CAM_CTRL_BLUE_BALANCE:
    {
      ...
      if ( euvcUsbControlMsg ( cameraInfo, USB_DIR_OUT | USB_CTRL_TYPE_CLASS |
          ...
          cameraInfo->processingUnitId << 8, ( char* ) &balance,
    ...
    case OA_CAM_CTRL_AUTO_EXPOSURE:
      ...
      if ( euvcUsbControlMsg ( cameraInfo, USB_DIR_OUT | USB_CTRL_TYPE_CLASS |
          ...
          EUVC_CAM_TERMINAL << 8, ( char* ) &cameraInfo->autoExposure,
    ...
    case OA_CAM_CTRL_AUTO_WHITE_BALANCE:
      ...
      if ( euvcUsbControlMsg ( cameraInfo, USB_DIR_OUT | USB_CTRL_TYPE_CLASS |
          ...
          cameraInfo->processingUnitId << 8,
          ( char* ) &cameraInfo->autoWhiteBalance,
...
_processSetResolution ( oaCamera* camera, OA_COMMAND* command )
{
  ...
  if ( euvcUsbControlMsg ( cameraInfo, USB_DIR_OUT | USB_CTRL_TYPE_CLASS |
      ...
      ( char* ) &probe, sizeof ( probe ), USB_CTRL_TIMEOUT ) !=
      sizeof ( probe )) {
